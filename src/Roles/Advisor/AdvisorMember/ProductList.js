...
const styles = {
    typography: {
        ...
        fontSize: '2.5rem', // Increase for Product List title
        marginBottom: '20px',
    },
    button: {
        fontFamily: 'Poppins, sans-serif',
        fontWeight: 600,
        fontSize: baseFontSize, // Increase button text size
        color: '#FFF',
    ...
    readonly: {
        ...
        borderRadius: '8px',
        fontSize: baseFontSize, // Increase size for readonly text fields
    },
    tableCell: {
        padding: '10px',
        textAlign: 'center',
        fontSize: baseFontSize, // Increase size for table cell text
    },
    icon: {
        color: 'green',
        marginRight: '8px',
    ...
    container: {
        position: 'relative',
        zIndex: 2, // Ensure container content is above the glass effect
    }
};
...
function ProductList() {
    ...
    return (
        <div style={styles.pageStyle}>
            <div style={styles.glassEffect}></div> {/* Glass effect overlay */}
            <Sidebar />
            <Container className="mt-5" style={styles.container}>
                ...
                <TextField
                    ...
                    sx={{
                        borderRadius: '20px',
                        fontFamily: 'Poppins, sans-serif',
                        fontSize: baseFontSize, // Increase search input text size
                        maxWidth: '400px',
                        width: '100%',
                        margin: '0 auto',
                    }}
                ...
                <FormControl variant="outlined" fullWidth className="mb-4">
                    ...
                    <Select
                        ...
                        onChange={(e) => {
                            ...
                            setSelectedSubCategory(''); // Reset subcategory selection on main category change
                        }}
                        label="Main Category"
                    >
                        <MenuItem value="">
